  ...
  return (
    ...
    <div className="registerForm">
        <form method="POST" className='form'>
            ...
            <input onChange={inputChange} value={state.name} type="text" placeholder='Name' name='name'/>
            </div>
            <div className="inputVal">
            <FaVoicemail className='registeriCon'/>
            <input onChange={inputChange} value={state.email} type="text" placeholder='Email' name='email'/>
            </div>
            <div className="inputVal">
            <FaPhone className='registeriCon'/>
            <input onChange={inputChange} value={state.phone} type="text" placeholder='Phone' name='phone'/>
            </div>
            <div className="inputVal">
            <FaLock className='registeriCon'/>
            <input onChange={inputChange} value={state.password} type="text" placeholder='Password' name='password' />
            </div>
            <div className="inputVal">
            <FaLock className='registeriCon'/>
            <input onChange={inputChange} value={state.cpassword} type="text" placeholder='Confirm Password' name='cpassword'/>
            </div>

            <input type="submit" onClick={PostData}  className='inputBtn'/>
    <br /><span> Already Register : </span><a onClick={LoadIgnorer} href="/login">Login In</a>
